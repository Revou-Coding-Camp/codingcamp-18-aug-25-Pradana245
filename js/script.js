...
function renderFilteredTodoList(todos) {
  ...
  todos.forEach(function (todo) {
    ...
    taskItem.className =
      "task-item glass rounded-lg p-4 flex items-center justify-between" +
    ...
    taskItem.innerHTML =
      ...
      "</div>" +
      '<div class="text-white opacity-50 text-sm">Due: ' +
      ...
      '<button data-task-id="' +
      todo.id +
      '" class="delete-task-btn text-red-400 hover:text-red-300 p-2 rounded-lg hover:bg-red-500 hover:bg-opacity-10 transition-colors">' +
